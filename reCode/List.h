...
class List{
    ...
    public:
        ...
        friend class Bao;
        friend class TapChi;
        int static TacGia_count;
        int static Bao_count;
        int static TapChi_count;
...
//          getter
    ...
    //  Chinh sua thong tin
        ...
        //Sap xep bao
        void List_sapXepBaoTheoTacGia_ten();
        ...
        void List_insertTacGia(string);
        void List_insertTapChi(string);
        void List_insertBao(string);
        void List_insertNXB(string);
        //Xuat ra file
        void List_outTacGia();
        void List_outTapChi();
        void List_outNXB();
